...
m_aryPages = {
    "Home": uix.pages.lit_about,
    "Claims": uix.pages.lit_claimAnalysis,
    "Anomalies": uix.pages.lit_claimAnalysis,
    "Model - GBC": uix.pages.lit_claimAnalysis,
    "Model - Txf": uix.pages.lit_claimAnalysis,
...
def init():
    ...
    with st.sidebar:
        ...
        st.sidebar.markdown('<why this is important> ...')
        st.sidebar.markdown('Kaggle Claims Data - (assume 2022)')
