...
#--- global array of page names, and descr
moduleNames = lit_packages.packages()
descriptions = [] 
modules = []

#aryDescr, aryPkg = lit_packages.get_aryPkgDescr()
...
def format_func(name):
    ...
    #return aryDescr[moduleNames.index(name)]
...
with st.sidebar:
    ...
    #page = st.selectbox('Select:', aryPkg, format_func=format_func) 
